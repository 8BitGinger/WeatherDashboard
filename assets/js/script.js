...
const API_KEY = "5eb79fc09e1638a0fb6c8df9283a6d51"; // API key for OpenWeatherMap API

// opted not to go for JS due to the compelexity of the tutorial, but
//upate with dayJS for easier date formatting.  
...
const getButtonCoordinates = () => {
    const cityName = cityBtnEl.id;
    const API_URL = `https://api.openweathermap.org/geo/1.0/direct?q=${cityName}&limit=1&appid=${API_KEY}`;
